...
public class EditDistance {
    ...
    public int recEditDistance(char[]  str1, char str2[], int len1,int len2){
        ...
        if(str1[len1] == str2[len2])
        	return recEditTusharRoy(str1, str2, len1 + 1, len2 + 1);
        
        return 1+ min(	recEditTusharRoy(str1, str2, len1 + 1, len2 + 1), 
        			recEditTusharRoy(str1, str2, len1, len2 + 1), 
        			recEditTusharRoy(str1, str2, len1 + 1, len2));
    }
